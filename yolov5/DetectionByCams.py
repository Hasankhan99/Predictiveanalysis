...
check=''
# api_token="http://3.18.96.94/DeepScienceApi/api/Surveillance/getCamStoreData"

# headers = {'Content-Type': 'application/json',
#             'Authorization': 'Bearer {0}'.format(api_token)}
# def get_result():
#     response = requests.get(api_token, headers=headers)
...
#     # channels_uids.append({'StoreUID': i['StoreUID'], 'Channels':i['Channels']})

#     # print(path)
#     if str(i['StoreUID'])!='70144329':
#         path="/media/hk/hk/cams/Compliefile/C:/Store_Cam_picture/"+str(i['StoreUID'])+"/"+str(i['Channels'])+"/20201230/*.jpg"
#         paths.append([path,str(i['StoreUID'])])
...
def Hourly_API_Call(suid,Hour):
    ...
    api_token=api_token + str(yesterday)+ '/'      #  Date 
    api_token=api_token + str(check)      #  Date 
