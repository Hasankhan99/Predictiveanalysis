...
from ForOneStore import detect
total=[0]
totalcount=0
total_h=[0]
totalcount_h=0
...
def localDB(storuid,totalcounts, totalcounts_h, Hour, status=False):  
    ...
    conn = sqlite3.connect('foronestore_feb14.db')
...
def API_Call(suid):
    ...
    api_token=api_token + str('2021-02-13') + '/'      #  Date 
...
# ======================================================================
    ...
    for rasta in range(len(surpath)):
        ...
        path33="/media/live/livedb/cams/Compliefile/C:/Store_Cam_picture/"+str(surpath[rasta])+"/"+str(surche[rasta])+"/20210214/*.jpg"
